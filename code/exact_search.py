    ...
    def search(self, 
        ...
        for batch_num, corpus_start_idx in tqdm(enumerate(itr),total=len(itr)):
            ...
            for query_itr in range(len(query_embeddings)):
                ...
                if kwargs["bm25_result"] is not None and query_id in kwargs["bm25_result"]:
                    bm25_scores = kwargs["bm25_result"][query_id]
                else:
                    bm25_scores = None
                for sub_corpus_id, score in zip(cos_scores_top_k_idx[query_itr], cos_scores_top_k_values[query_itr]):
                    ...
                    if corpus_id != query_id:
                        ...
                        elif corpus_id not in bm25_scores:
                            self.results[query_id][corpus_id] = 0
                        else:
                            self.results[query_id][corpus_id] = score * bm25_scores[corpus_id]
